...
class EngineCommand extends HavenCommand {
  EngineCommand() {
...
class EnginePrepareCommand extends HavenCommand {
  EnginePrepareCommand() {
    argParser.addOption(
      'fork',
      help:
          'The origin to use when cloning the engine, haven will set the upstream automatically.',
      valueHelp: 'url',
    );
    argParser.addFlag(
      'force',
...
class EngineBuildEnvCommand extends HavenCommand {
  @override
