...
Map<String, dynamic>? parsePrefsJson(String contents, HVLogger log) {
...
Future<HavenGlobalPrefsModel> _readGlobalPrefs({
  required Scope scope,
  required File jsonFile,
}) async {
...
Future<HavenGlobalPrefsModel> _updateGlobalPrefs({
  required Scope scope,
  required File jsonFile,
  required FutureOr<void> Function(HavenGlobalPrefsModel prefs) fn,
...
final globalPrefsProvider = Provider<Future<HavenGlobalPrefsModel>>(
  (scope) =>
...
Future<HavenGlobalPrefsModel> updateGlobalPrefs({
  required Scope scope,
  required FutureOr<void> Function(HavenGlobalPrefsModel prefs) fn,
  bool background = false,
}) async {
...
class HavenInternalPrefsVars {
  HavenInternalPrefsVars({required this.scope, required this.config});
