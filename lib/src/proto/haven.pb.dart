...
class EnvironmentListModel extends $pb.GeneratedMessage {
  factory EnvironmentListModel({
    ...
    if (projectEnvironment != null) result.projectEnvironment = projectEnvironment;
...
class CommandResultModel extends $pb.GeneratedMessage {
  factory CommandResultModel({
    ...
    if (environmentUpgrade != null) result.environmentUpgrade = environmentUpgrade;
    return result;
  }
...
class HavenGlobalPrefsModel extends $pb.GeneratedMessage {
  ...
  HavenGlobalPrefsModel._();

  factory HavenGlobalPrefsModel.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory HavenGlobalPrefsModel.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HavenGlobalPrefsModel',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenGlobalPrefsModel clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenGlobalPrefsModel copyWith(void Function(HavenGlobalPrefsModel) updates) =>
      super.copyWith((message) => updates(message as HavenGlobalPrefsModel))
          as HavenGlobalPrefsModel;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static HavenGlobalPrefsModel create() => HavenGlobalPrefsModel._();
  @$core.override
  HavenGlobalPrefsModel createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static HavenGlobalPrefsModel getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<HavenGlobalPrefsModel>(create);
  static HavenGlobalPrefsModel? _defaultInstance;
...
class HavenEnvPrefsModel extends $pb.GeneratedMessage {
  factory HavenEnvPrefsModel({
    ...
    if (engineForkRemoteUrl != null) result.engineForkRemoteUrl = engineForkRemoteUrl;
    if (precompileTool != null) result.precompileTool = precompileTool;
    if (patched != null) result.patched = patched;
    return result;
  }

  HavenEnvPrefsModel._();

  factory HavenEnvPrefsModel.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory HavenEnvPrefsModel.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HavenEnvPrefsModel',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenEnvPrefsModel clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenEnvPrefsModel copyWith(void Function(HavenEnvPrefsModel) updates) =>
      super.copyWith((message) => updates(message as HavenEnvPrefsModel))
          as HavenEnvPrefsModel;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static HavenEnvPrefsModel create() => HavenEnvPrefsModel._();
  @$core.override
  HavenEnvPrefsModel createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static HavenEnvPrefsModel getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<HavenEnvPrefsModel>(create);
  static HavenEnvPrefsModel? _defaultInstance;
...
class HavenDotfileModel extends $pb.GeneratedMessage {
  factory HavenDotfileModel({
    $core.String? env,
    ...
    if (previousFlutterSdk != null) result.previousFlutterSdk = previousFlutterSdk;
    return result;
  }

  HavenDotfileModel._();

  factory HavenDotfileModel.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory HavenDotfileModel.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HavenDotfileModel',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenDotfileModel clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HavenDotfileModel copyWith(void Function(HavenDotfileModel) updates) =>
      super.copyWith((message) => updates(message as HavenDotfileModel))
          as HavenDotfileModel;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static HavenDotfileModel create() => HavenDotfileModel._();
  @$core.override
  HavenDotfileModel createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static HavenDotfileModel getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HavenDotfileModel>(create);
  static HavenDotfileModel? _defaultInstance;
