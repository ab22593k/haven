...
///   - Resulting state is either fully rolled back or left in clearly recoverable locations (e.g., .haven-trash).
...
class EnvTransaction {
  ...
  static Future<T> run<T>({
    ...
    final tx = EnvTransaction(HVLogger.of(scope));
  ...
  Future<Directory> moveToTrash(Directory dir) async {
    final trashDir = dir.fileSystem.directory('${dir.parent.path}/.haven-trash');
